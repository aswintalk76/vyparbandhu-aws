    ...
    return (
        <>
            <Header closeModal={closeModal} modalActive={modalActive} setModalActive={setModalActive} />
            {
                ...
                <div>
                    <div className='container-fluid' style={{ background: `url(${selectServicedata && selectServicedata.images})`, backgroundSize: "cover", minHeight: "350px" }}>
                            ...
                            <div className='row py-5'>
                                <div className='col-sm-12 mt-2 d-flex ' style={{ flexDirection: "column", justifyContent: 'center', alignItems: "center" }}>
                                    <h1 dangerouslySetInnerHTML={{ __html: modifiedHtmlHeading }}></h1>
                                    {
                                        ...
                                        <h3 className='fs-4 mt-3' dangerouslySetInnerHTML={{ __html: modifiedHtmlContent }}></h3>
                                    }
                                                            ...
                                                            <div className='col-sm-7 pt-3'>
                                                                {
                                                                    ...
                                                                    data.questions.map((question, index) => {
                                                                        return (
                                                                            <>
                                                                                <h3 className="mt-2" style={{ color: 'black' }}>{index + 1}. <span dangerouslySetInnerHTML={{ __html: question.question }}></span></h3>
                                                                                {/* <p>{question.description}</p> */}
                                                                                {/* <div dangerouslySetInnerHTML={{ __html: question.description }} style={{fontSize:"20px"}}>

                                                                                </div> */}
                                                                                <pre style={{ width: '100%', whiteSpace: 'pre-wrap', textAlign: 'justify', fontFamily: 'inherit', fontSize: "20px" }} dangerouslySetInnerHTML={{ __html: question.description }}>
                                                                        ...
                                                                        <>
                                                                            {
                                                                                ...
                                                                                <>
                                                                                    <h3 style={{ color: 'black' }}>{index + 1}. <span>{question.stepName}</span></h3>
                                                                                    <pre style={{ fontSize: '20px', width: '100%', whiteSpace: 'pre-wrap', textAlign: 'justify', fontFamily: 'inherit' }} dangerouslySetInnerHTML={{ __html: question?.description }}></pre>
                                        ...
                                        <div class="accordion-item" key={index}>
                                            ...
                                            <div id={collapseId} class="accordion-collapse collapse" aria-labelledby={headingId} data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <pre style={{ fontSize: '18px', width: '100%', whiteSpace: 'pre-wrap', textAlign: 'justify', fontFamily: 'inherit' }} dangerouslySetInnerHTML={{ __html: item.answer }}>
                                                        {/* {data.description} */}
                                                    </pre>
                                                </div>
                                            </div>
                                                ...
                                                <>
                                                    {
                                                        data?.package && data?.amount ?
                                                            ...
                                                            <div className="col-lg-4 col-sm-6 p-4" style={{ display: "flex", alignItems: 'stretch' }}>
                                                                ...
                                                                <div class="card " style={{ borderRadius: "15px" }} >
                                                                    <div className="text-center bg_orange text-white text_workflow d-flex" style={{ borderTopRightRadius: "15px", borderTopLeftRadius: "15px", height: "120px", flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                                                        <div>{data.package}</div>
                                                                        <div>₹ {data.amount}</div>
