                                    ...
                                    return (
                                        <>
                                            <div class="card single_post">
                                                <div class="body">
                                                    <div class="img-post">
                                                        <img class="d-block img-fluid w-100" src={`${item.image && item.image}`} alt="First slide" />
                                                    </div>
                                                    ...
                                                    <p>
                                                        <pre dangerouslySetInnerHTML={{ __html: truncateText(item.details) }} style={{ width: '100%', whiteSpace: 'pre-wrap', textAlign: 'justify', fontFamily: 'inherit', fontSize: "18px", fontWeight: "400" }}>
                                                    ...
                                                    return (
                                                        <>
                                                            ...
                                                            <div class="single_post">
                                                                <h4 class="m-b-0 ">{item.heading}</h4>
                                                                <span>{item.date}</span>
