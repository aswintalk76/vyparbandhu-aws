                        ...
                        <div className='card px-sm-5 px-3 m-sm-5' style={{ width: "auto" }}>
                            <div className="row my-3 ">
                                ...
                                <div className="mb-3 row" >
                                    ...
                                    <div className="col-sm-12">
                                        <input type="number" placeholder="Mobile" className="form-control"  value={phoneNumber} onChange={(e)=>{setPhoneNumber(e.target.value)}}  />
                                    </div>
                                </div>
                                <div className="mb-3 row">
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-12">
                                        <textarea placeholder="Write your Query in Details" className="form-control" rows="2" value={details} onChange={(e)=>{setDetails(e.target.value)}}></textarea>
                                    </div>
                                </div>
                                <div className="mb-3 row">
                                    <div className="col-sm-12">
