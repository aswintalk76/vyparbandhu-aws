        ...
        <div className='container-fluid' >
            <div className="py-sm-5 py-3 px-sm-5">
                <div className='d-flex justify-content-center'>
                    <h1 className="text-center heading_main">{services?.heading}</h1>
                </div>
                <div className="row py-sm-5 py-2" >
                    {
                        services?.data?.map((item, index) => {
                            return (
                                <>
                                    <div className="col-lg-4  col-sm-6 text-center py-3  mx-auto  mb-3 ml-2">
                                        <div className='border rounded card2' style={{ padding: "15px 9px", height: "100%" }}>

                                            <img src={item.image ? item.image : Trademark}  alt="" height="80px" width="100px" />
